                  ...
                  <div style={{ padding: "20px 24px" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 12 }}>
                      <div>
                        ...
                        <div style={{ 
                          ...
                          {cirugia.fecha_cirugia ? new Date(cirugia.fecha_cirugia).toLocaleDateString('es-CL') : 'Sin fecha'}
                        </div>
                      </div>
                    ...
                    <div style={{ marginBottom: 16 }}>
                      <div style={{ 
                        ...
                        <span>Evaluaciones: {cirugia.evaluaciones?.length || 0} / {cirugia.esquema?.total || 6}</span>
                        <span>{progreso}%</span>
                      </div>
                      <div style={{ 
                        height: 8, 
