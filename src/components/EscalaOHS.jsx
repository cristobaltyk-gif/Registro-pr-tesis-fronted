...
const PREGUNTAS = [
  {
    id: 1,
    texto: "¿Cómo describiría el dolor habitual de su cadera?",
    opciones: [
  ...
  {
    id: 2,
    texto: "¿Ha tenido dificultad para lavarse y secarse (todo el cuerpo) a causa de su cadera?",
    opciones: [
  ...
  {
    id: 3,
    texto: "¿Ha tenido dificultad para entrar y salir de un auto a causa de su cadera?",
    opciones: [
      { valor: 4, label: "Sin dificultad" },
      { valor: 3, label: "Poca dificultad" },
      { valor: 2, label: "Dificultad moderada" },
  ...
  {
    id: 4,
    texto: "¿Cuánto tiempo puede caminar antes de que el dolor de su cadera sea intenso?",
    opciones: [
  ...
  {
    id: 5,
    texto: "Después de una comida, ¿cuánta dificultad tiene para levantarse de una silla a causa de su cadera?",
    opciones: [
      { valor: 4, label: "Sin dificultad" },
      { valor: 3, label: "Poca dificultad" },
      { valor: 2, label: "Dificultad moderada" },
  ...
  {
    id: 6,
    texto: "¿Ha coxeado (cojeado) al caminar a causa de su cadera?",
    opciones: [
  ...
  {
    id: 7,
    texto: "¿Puede ponerse los calcetines, medias o zapatos?",
    opciones: [
  ...
  {
    id: 8,
    texto: "¿Ha tenido dolor de cadera por la noche en la cama?",
    opciones: [
  ...
  {
    id: 9,
    texto: "¿Cuánto ha interferido el dolor de su cadera en su trabajo habitual (incluidas las tareas del hogar)?",
    opciones: [
      { valor: 4, label: "Nada" },
  ...
  {
    id: 10,
    texto: "¿Ha tenido sensación de bloqueo, crujido o chasquido en su cadera al moverse?",
    opciones: [
      { valor: 4, label: "Raramente / nunca" },
      { valor: 3, label: "A veces o solo al principio" },
      { valor: 2, label: "A menudo, no solo al principio" },
...
function getInterpretacion(score) {
  ...
  if (score >= 27) return { label: "Moderado",    color: "#d97706" };
  return                   { label: "Severo",     color: "#dc2626" };
}

export default function EscalaOHS({ onComplete, onBack }) {
  ...
  function handleOpcion(valor) {
    ...
    if (!esUltima) {
      ...
      onComplete?.({ escala: "OHS", respuestas: nuevas, score, interpretacion: getInterpretacion(score).label });
    }
  }
