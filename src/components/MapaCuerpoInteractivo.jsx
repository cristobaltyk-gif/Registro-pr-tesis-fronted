...
const PUNTOS_ARTICULACIONES = [
  { id: "cadera-derecha",    x: 161, y: 373, label: "Cadera D",  lado: "derecha"   },
  { id: "cadera-izquierda",  x: 239, y: 373, label: "Cadera I",  lado: "izquierda" },
  { id: "rodilla-derecha",   x: 169, y: 465, label: "Rodilla D", lado: "derecha"   },
  { id: "rodilla-izquierda", x: 231, y: 465, label: "Rodilla I", lado: "izquierda" },
];
...
function IconoCadera({ x, y, color = "#2563eb", lado = "derecha" }) {
  ...
  return (
    <g transform={`translate(${x}, ${y}) scale(${flip}, 1)`}>
      ...
      <path d="M 5,11 L 13,11 L 11,28 L 7,28 Z" fill={color} />
    </g>
  );
}
...
function IconoRodilla({ x, y, color = "#2563eb", lado = "derecha" }) {
  ...
  return (
    <g transform={`translate(${x}, ${y}) scale(${flip}, 1)`}>
      <path d="M -7,-10 Q -8,-4 -5,-2 L 5,-2 Q 8,-5 7,-10 Q 5,-11 3,-10 Q 0,-9 -3,-10 Q -5,-11 -7,-10 Z" fill={color} />
