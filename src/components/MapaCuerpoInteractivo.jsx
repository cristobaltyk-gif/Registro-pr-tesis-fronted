...
const PUNTOS_ARTICULACIONES = [
  ...
  { id: "cadera-derecha",    x: 170, y: 310, label: "Cadera D",  lado: "derecha"   },
  // Cadera izquierda del paciente = derecha del observador
  { id: "cadera-izquierda",  x: 230, y: 310, label: "Cadera I",  lado: "izquierda" },
  { id: "rodilla-derecha",   x: 168, y: 440, label: "Rodilla D", lado: "derecha"   },
  { id: "rodilla-izquierda", x: 232, y: 440, label: "Rodilla I", lado: "izquierda" },
];
